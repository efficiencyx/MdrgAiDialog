...
public class WavAudio {
  /// <summary>
  /// Interleaved samples in the -1..1 range
  /// </summary>
  ...
  /// <summary>
  /// Parses a RIFF/WAVE byte buffer (PCM 16/24/32-bit and IEEE float 32-bit)
  /// </summary>
  /// <param name="data">Raw WAV file bytes</param>
  /// <returns>Decoded audio</returns>
  /// <exception cref="InvalidDataException">Thrown when the buffer is not a supported WAV file</exception>

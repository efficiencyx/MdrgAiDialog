...
public static class ProviderPicker {
  ...
  // Builds and shows the picker panel. No-op if already open.
  ...
  // Re-opens the provider grid (used by the settings panel's Back button).
  ...
  // ProviderSettingsPanel after it has written the provider's settings.
